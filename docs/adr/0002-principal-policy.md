...
Email, data, phone, payment, search, image, video, 3D, CAD, MCP servers and other external systems live behind semantic capabilities. Those providers are replaceable/routable.
